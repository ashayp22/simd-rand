...
pub trait SimdRandX8 {
    ...
    #[inline(always)]
    fn next_f32x8(&mut self) -> f32x8 {
        let v = self.next_u64x8();

        f64x8::from_array([
            (v[0] >> 11) as f32 * (1.0 / (1u64 << 53) as f32),
            (v[1] >> 11) as f32 * (1.0 / (1u64 << 53) as f32),
            (v[2] >> 11) as f32 * (1.0 / (1u64 << 53) as f32),
            (v[3] >> 11) as f32 * (1.0 / (1u64 << 53) as f32),
            (v[4] >> 11) as f32 * (1.0 / (1u64 << 53) as f32),
            (v[5] >> 11) as f32 * (1.0 / (1u64 << 53) as f32),
            (v[6] >> 11) as f32 * (1.0 / (1u64 << 53) as f32),
            (v[7] >> 11) as f32 * (1.0 / (1u64 << 53) as f32),
        ])
    }
